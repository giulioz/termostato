...
const defaultConfig = {
  ...
  programming: [
    ...
    { hour: 6, temperature: 21.5 },
    { hour: 7, temperature: 21.5 },
    { hour: 8, temperature: 21.5 },
    { hour: 9, temperature: 19 },
    { hour: 10, temperature: 19 },
    { hour: 11, temperature: 19 },
    { hour: 12, temperature: 19 },
    { hour: 13, temperature: 19 },
    { hour: 14, temperature: 19 },
    { hour: 15, temperature: 19 },
    { hour: 16, temperature: 19 },
